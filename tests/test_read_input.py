...
assert isinstance(test_simblock,     assert)
...
assert isinstance(test_main,     assert)assert isinstance(test_main["main_cyl"],     assert)    assert test_main["main_cyl"].r == 0.5
assert test_main["main_cyl"].z_max == 1.0
assert isinstance(test_main["main_cone"],     assert )    assert test_main["main_cone"].r_lower == 0.1
