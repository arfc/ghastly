...
dep_file = 'openmc_models/inf_lat_dep/dep-corner/iter3/i2_dep_res.h5'
mat_file = 'openmc_models/inf_lat_dep/dep-corner/iter3/input_mats.xml'
...
dep_triso_cells = [openmc.Cell(fill=bg, region=-triso_bounds[0]),
